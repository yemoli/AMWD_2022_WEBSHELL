...
def features_process(negativedir, postivedir, maxfeatures):
    ...
    joblib.dump(countvectorizer, "model/php/countvectorizer_" + options.version + ".pkl")
    joblib.dump(tfidftransformer, "model/php/tfidftransformer_" + options.version + ".pkl")
...
def train(trainset, lables, mode, seed):
    ...
    clfname = "model/php/" + mode + "_" + options.version + ".pkl"
